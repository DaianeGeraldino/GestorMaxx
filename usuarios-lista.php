      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          ...
          <div class="btn-toolbar mb-2 mb-md-0">
            <a href="criar-usuario.html" class="btn btn-primary">
              ...
              <table class="table table-hover">
                ...
                <tbody id="lista-usuarios">
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-sm btn-outline-primary" title="Editar" onclick="location.href='editar-usuario.html'">
                  ...
                  <tr>
                    ...
                    <td><span class="badge bg-warning text-dark">Estoquista</span></td>
